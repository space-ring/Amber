...
EngineEvent::EngineEvent() = default;

window_events::Event::Event(const GLFWwindow* window) : window(window) {}

window_events::EnterEvent::EnterEvent(const GLFWwindow* window, const int entered) : Event(window), entered(entered) {}

window_events::FocusEvent::FocusEvent(const GLFWwindow* window, const int focused) : Event(window), focused(focused) {}
...
window_events::MotionEvent::MotionEvent(const GLFWwindow* window, const double xpos, const double ypos) : Event(window),
                                                                                                          xpos(xpos),
                                                                                                          ypos(ypos) {}
...
window_events::ScrollEvent::ScrollEvent(const GLFWwindow* window, const double xoffset, const double yoffset) : Event(
