...
A mesh is a wrapper for an OpenGL VAO. It contains an object's vertex data: position, texture and normal.
The VAO has attributes at locators:
 - 0 = vec3f vertex position
 - 1 = vec2f vertex texture coordinates (UV)
